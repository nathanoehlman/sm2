var async = require('async'),
    ...
    appPrefix = 'app::',
    reTrailingSlash = /\/$/,
    _isWin = os.platform() == "win32" || os.platform() == "win64",
...
// handle process end
process.on(_isWin ? 'CTRL_CLOSE_EVENT' : 'SIGTERM', _handleTerminate);
process.on(_isWin ? 'CTRL_BREAK_EVENT' : 'SIGKILL', _handleTerminate);
process.on(_isWin ? 'CTRL_LOGOFF_EVENT' : 'SIGHUP', _handleTerminate);
